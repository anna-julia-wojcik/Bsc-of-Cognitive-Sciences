def macros(user, tdee_value: float) -> dict:
    if user.target == "lose":
...
def recommendations(user) -> dict:
    ...
    if "vegan" in user.diet_type:
        forbidden = ["chicken", "turkey", "lean beef", "fish", "eggs", "cottage cheese", "Greek yogurt", "marine fish"]
